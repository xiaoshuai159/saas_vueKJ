    ...
    <el-card  style="border-radius: 0px" shadow="never">
      <el-main style="background-color: white">
        <el-row :gutter="20" style="margin-bottom: 25px; margin-top: -12px">
          <el-col :span="4">
            <div class="grid-content bg-purple" style="font-size: 16px; margin-top: 9px; margin-left: -53px">
              事件详情
            </div>
          </el-col>
          <el-col :span="20">
            <div class="grid-content bg-purple">
              <div align="left">
                ...
                &nbsp;&nbsp;<el-select v-model="searchValue.value2" clearable placeholder="请选择" ref="selectLable2">
                  <el-option v-for="item in options2" :key="'new1' + item.value2" :label="item.label2"
                    :value="item.value2">
                  </el-option>
                </el-select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 单位类型
                &nbsp;&nbsp;<el-select v-model="searchValue.value3" clearable placeholder="请选择" ref="selectLable3">
                  <el-option v-for="item in options3" :key="'new2' + item.value3" :label="item.label3"
                    :value="item.value3">
                  </el-option>
                </el-select>
              </div>
              ...
              <div align="left">
                涉事IP &nbsp;&nbsp;<el-input v-model="searchValue.input1" placeholder="单行输入" style="width: 20%">
                </el-input>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;涉事单位
                &nbsp;&nbsp;<el-input v-model="searchValue.input2" placeholder="单行输入" style="width: 20%"></el-input>
              </div>
              <div align="left">
                <el-button @click="chaxun">查询</el-button>
                <el-button @click="daochu()" :disabled="isDisabled">导出</el-button>
                <el-button @click="newdaochu()" :disabled="isDisabled" class="newButton">最近记录导出</el-button>
              </div>
            </div>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <div class="block">
              <el-table stripe border class="tableClass" v-loading="loading" ref="multipleTable" :data="
                tableData.slice(
              ...
              " tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="IP" prop="_id" min-width="130" sortable>
                  ...
                  <template slot-scope="scope">
                    <span v-if="scope.row._id != ''&&$store.state.userinfo.user_level==5"> {{ numberMask(scope.row._id)
                    }}</span>
                ...
                <el-table-column prop="event_type" label="事件类型" min-width="110" sortable show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="city" label="涉及城市" min-width="100" v-if="false">
                </el-table-column>
                <el-table-column prop="district" label="涉及地区" min-width="100" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="unit_type" label="涉及单位类型" min-width="105" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="unit_name" label="涉及单位名称" min-width="200" show-overflow-tooltip>
                  <template slot-scope="scope">
                    <span v-if="scope.row.unit_name != ''&&$store.state.userinfo.user_level==5"> {{
                    companyMask(scope.row.unit_name) }}</span>
  ...
  methods: {
    filterOptions1() {
      ...
      for (var i = 0; i < this.tableData.length; i++) {
        list1.push(this.tableData[i].district);
      }
